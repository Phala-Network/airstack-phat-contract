...
async function main() {
  ...
  consumer.on("ResponseReceived", async (reqId: number, requester: string, target: string, score: string) => {
  ...
  consumer.on("ErrorReceived", async (reqId: number, requester: string, target: string, error: string) => {

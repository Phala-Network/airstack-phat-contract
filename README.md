...
1. Create a template from the [`airstack-starter-kit`](https://github.com/Phala-Network/airstack-phat-contract) template repo. Click on the "**Use this template**" button in the top right corner of the webpage. Then skip the `npx @phala/fn@latest init example` step.
  ![](./assets/AirstackTemplate.png)
...
```bash
npm run run-function -- -a  '{"apiUrl": "https://api.airstack.xyz/gql", "apiKey": "3a41775a358a4cb99ca9a29c1f6fc486"}'
```
